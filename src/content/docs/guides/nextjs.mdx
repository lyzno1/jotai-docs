...
[Open in StackBlitz](https://stackblitz.com/edit/stackblitz-starters-nsugnt?file=store%2Findex.ts,components%2FClock.tsx)

#### HN Posts

Page Router demo:

[Open in StackBlitz](https://stackblitz.com/edit/stackblitz-starters-cnz9lg?file=store%2Findex.ts,pages%2F_app.tsx,pages%2Findex.tsx)
