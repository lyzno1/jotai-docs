...
[Open in StackBlitz](https://stackblitz.com/edit/vitejs-vite-oqfhy4?file=src%2FApp.tsx)

Restartable machine:

[Open in StackBlitz](https://stackblitz.com/edit/vitejs-vite-tqdtym?file=src%2FApp.tsx)
